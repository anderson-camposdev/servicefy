    ...
    <div className="h-full overflow-y-auto bg-slate-50 p-6"><div className="max-w-6xl mx-auto">
      ...
      <header className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button onClick={() => void load()} aria-label="Atualizar conexões" className="rounded-xl border border-slate-200 bg-white p-2.5 transition hover:bg-slate-50"><RefreshCw className="w-4 h-4" /></button>
        </div>
      </header>
