...
// Guarda de SSRF de linha de base — não é exaustiva (não resolve DNS nem
// protege contra redirecionamento/rebinding), mas bloqueia os alvos óbvios
// mais comuns (metadados de nuvem, loopback, redes privadas) antes de
