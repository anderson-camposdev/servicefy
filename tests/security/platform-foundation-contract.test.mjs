...
const adminSql = read('supabase/migrations/076_admin_settings_foundation.sql')
const channelSql = read('supabase/migrations/077_omnichannel_gateway.sql')
const esmSql = read('supabase/migrations/078_esm_case_core.sql')
const cmdbSql = read('supabase/migrations/079_cmdb_knowledge_virtual_agent.sql')
const maturitySql = read('supabase/migrations/080_esm_maturity.sql')
